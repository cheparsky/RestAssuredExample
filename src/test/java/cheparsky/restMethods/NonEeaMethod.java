...
public class NonEeaMethod extends ConsentJSONFactory implements RestMethod {
    ...
    public static class NonEeaMethodBuilder extends ConsentBuilder implements cheparsky.restMethods.RestMethod.RestMethodBuilder {
