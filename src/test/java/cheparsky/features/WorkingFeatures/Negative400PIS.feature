...
Potrzeba biznesowa: Testowanie metody payments w rest
  ...
  @NonEaa
    Przykłady:
      ...
      | Przelew zagraniczny inny niż SEPA | SCOPE                  | account                          |
  ...
  Przy inicjalizacji <typ przelewu> wysyłamy zapytanie z pustą wartością pola <pole>
    ...
    Kiedy tworzymy zapytanie consent
    I budujemy body consent
    I skasujemy z body zapytania w miejsce 'consentScope.scopeDetails.privilegeList.paymentDomestic.domesticPaymentRequest' klucze '<pole>'
