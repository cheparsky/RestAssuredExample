...
Potrzeba biznesowa: Testowanie metody payments w rest
  ...
  @Positive
  @payment
  Szablon scenariusza: Testowanie pozytywnej inicjalizacji <typ scenariusza> z wyborem rachunku na formatce

  Przy inicjalizacji <typ scenariusza> wybieramy numer rachunku na stronie autoryzacji zgody
