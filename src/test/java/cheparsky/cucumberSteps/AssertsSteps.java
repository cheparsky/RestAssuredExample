...
public class AssertsSteps {
    ...
    @Then("^status odpowiedzi (consent|scope|payment|status|account|patch) jest (.+)")
    ...
    @Then("^jest wartość odpowiedzi (consent|scope|payment|status|account) (.+)")
    ...
    @Then("^odpowiedź (consent|scope|payment|status|account) zawiera pole (.+) z wartościami w liście '(.+)'")
    ...
    @Then("^odpowiedź (consent|scope|payment|status|account) zawiera pole (.+) z wartoścą w liście '(.+)'")
    ...
    @Then("^odpowiedź (consent|scope|payment|status|account) zawiera pole (.+) z wartoścą '(.+)'")
...
/*    public static Response getResponseByType (String typeOfResponse){
        ...
        else if(typeOfResponse.equals("payment")) response = RESTSteps.paymentRequest.getResponse();
