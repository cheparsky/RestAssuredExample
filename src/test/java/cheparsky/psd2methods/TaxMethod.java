...
public class TaxMethod extends ConsentJSONFactory implements PSD2Method {
    ...
    public static class TaxMethodBuilder extends ConsentBuilder implements PSD2MethodBuilder {
