...
Potrzeba biznesowa: Testowanie metod PIS w ramach psd2
  ...
  Szablon scenariusza: Testowanie inicjalizacji <typ przelewu> z dodatkową metodą 'pisDo'
  ...
  Przy inicjalizacji <typ przelewu> wysyłamy zapytanie z pustą wartością pola <pole>
    ...
    Przykłady:
      | typ przelewu    | metoda      |
      | Przelew krajowy | pisDomestic |
      | Przelew krajowy | pisTax |
      | Przelew krajowy | pisEea |
      | Przelew krajowy | pisNonEea |
